//! ## Implementations of the errors that can occur when parsing KeyFile elements
...
#[derive(Debug, thiserror::Error)]
#[error("Invalid Encoding: encoding modifiers may only contain alphanmumeric ASCII characters and hyphens")]
pub struct InvalidEncoding;

/// Error that is returned when attempting to construct a [`Modifier`] from an invalid string
#[derive(Debug, thiserror::Error)]
#[error("Invalid Modifier: locale modifiers may only contain alphabetic ASCII characters")]
