...
/// Struct that represents a key-value pair and other associated data.
///
...
/// Struct representing a parsed locale identifier.
...
impl<'a> Locale<'a> {
    ...
    /// Method for getting the country / terretory identifier.
...
/// Struct that represents a group of key-value pairs and other associated data.
///
